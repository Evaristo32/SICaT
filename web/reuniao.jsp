...
<!--                                    <button  onClick="funcaoDoisEmUma('${reunioesConfirmadas.getIdReuniao()}')" class="btn-warning">
                                        Alterar</button>-->
                                    <button  onclick="location.href = 'VisualizarReuniaoConfirmadaCoordenador?idReuniao=${reunioesConfirmadas.getIdReuniao()}'" class="btn-success">
                                       Visualizar </button> 
                                    </td>
                            </tr> 
                        </c:forEach>
...
<!--                                    <button  onClick="funcaoDoisEmUma('${reunioesRecusadas.getIdReuniao()}')" class="btn-warning">
                                        Alterar</button>-->
                                    <button  onclick="location.href = 'VisualizarReuniaoRecusadaCoordenador?idReuniao=${reunioesRecusadas.getIdReuniao()}'" class="btn-success">
                                        Visualizar</button> 
...
<!--                                    <button  onClick="funcaoDoisEmUma('${reunioesConcluidas.getIdReuniao()}')" class="btn-warning">
                                        Alterar</button>-->
                                    <button  onclick="location.href = 'VisualizarReuniaoConcluidaCoordenador?idReuniao=${reunioesConcluidas.getIdReuniao()}'" class="btn-success">
                                        Visualizar</button> 
