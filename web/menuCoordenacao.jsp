                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown ">
                                <a  onClick="location.href = 'ListarReivindicacaoCoordenador'" class="dropdown-toggle AA " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Analizar Reivindicação</a>
                            </li>
