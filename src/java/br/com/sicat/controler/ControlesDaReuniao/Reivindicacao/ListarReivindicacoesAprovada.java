...
public class ListarReivindicacoesAprovada extends HttpServlet {
   ...
   DaoReivindicacao daoReivindicacao = new DaoReivindicacao();
        System.out.println("OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOIIIIIIIIIIIIIIIIIIIII################################################");
        String status = "Aprovada";
        List<Reivindicacao> reivindicacoesAprovadas = daoReivindicacao.findByStatus(status);
