...
public class VisualizarReivindicacaoCoordenador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("VisualizarReivindicacaoCoordenador.jsp");
