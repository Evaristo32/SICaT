...
public class LisatarreivindicacoesEncerrado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Reivindicacao> reivindicacoesEncerrado = daoReivindicacao.findByStatus("Pronta Para Avaliar");
