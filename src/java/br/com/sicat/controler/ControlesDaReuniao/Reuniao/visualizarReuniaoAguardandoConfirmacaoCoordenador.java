...
public class visualizarReuniaoAguardandoConfirmacaoCoordenador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Reuniao reuniaoAguardandoConfirmacao = (Reuniao) daoReuniao.BuscarPorId(Reuniao.class, id);

        request.setAttribute("reuniaoAguardandoConfirmacao", reuniaoAguardandoConfirmacao);
        RequestDispatcher dispatcher = request.getRequestDispatcher("VisualizarReuniaoAguardandoConfirmacaoCoordenador.jsp");
