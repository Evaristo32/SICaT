...
public class ConfirmarReuniaoCoordenador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reuniao.setStatus("Confirmada");
        reuniao.setConfirmadaPeloCoordenador(request.getUserPrincipal().toString());
        daoReuniao.AlterarReuniao(reuniao);

           String msgSucesso = "Reunião de N° "+ reuniao.getIdReuniao() +" confirmada com sucesso.";
