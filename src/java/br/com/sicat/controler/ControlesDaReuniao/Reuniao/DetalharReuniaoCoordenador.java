...
public class DetalharReuniaoCoordenador extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       long id = Long.parseLong(request.getParameter("idReuniao"));
           ...
           Reuniao reuniaoAguardandoConfirmacao =(Reuniao) daoReuniao.BuscarPorId(Reuniao.class, id);
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("visualizarReuniaoAguardandoConfirmacao.jsp");
