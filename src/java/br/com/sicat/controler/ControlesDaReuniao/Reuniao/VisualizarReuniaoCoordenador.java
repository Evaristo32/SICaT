...
public class VisualizarReuniaoCoordenador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("telaDeVisualizarReuniaoCoordenador.jsp");
        dispatcher.forward(request, response);

        
        
        System.out.println("################################################################################# " + reuniaoParavisualizar.getRejeitadaPeloUsuario());
