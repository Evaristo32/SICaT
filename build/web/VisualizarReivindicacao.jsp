...
<html lang="pt-br">
    <head >
        ...
        <script>
            ...
            function AdicionarReivindicacao(id,idAprovar)
            {
                
                 if (document.getElementById(idAprovar).disabled == false) {
                    document.getElementById(idAprovar).disabled = true;
                } else {
                    document.getElementById(idAprovar).disabled = false;
                }
        ...
        <div class="container" style="margin-top: 2%;">
                ...
                <div class="panel-body">   
                    ...
                    <form action="IncluirStatusReprovada" name="reuniaoForm">
                        ...
                        <div class="botão">
                            <input type="checkbox" onclick="AdicionarReivindicacao('DescricaoDaReprovacao','aprovar')" value="Reprovar" > Rejeitar Reivindicação
                    ...
                    <div class="botão">
                        ...
                        <button id="aprovar" onclick="location.href = 'IncluirStatusAprovado?idReivindicacao=${reivindicacao.idReivindicacao}'" class="btn btn-success">Aprovar</button>
                    </div>
