        ...
        <div class="container" style="margin-top: 2%;">
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <div class="divInput" >
                        <input name="assunto" type="text" name="idReivindicacao"  class="form-control" value="${reuniaoRecusada.idReuniao}" readonly="" style="width:10%;" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="divInput" >
                            <input name="data" type="text" id="data"  class="form-control" value="${reuniaoRecusada.data}" disabled="disabled" style="width:15%; " />
                        </div>
                        ...
                        <div class="divInput" >
                            <input name="hora" type="text" id="hora"  class="form-control" value="${reuniaoRecusada.hora}" disabled="disabled" style="width:15%;" />
                        </div>
