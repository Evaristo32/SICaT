...
<html>
    <head lang="pt-br">
        ...
        <script>
            ...
            function AdicionarReivindicacao(id,idConfirmar)
            {
            ...
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    ...
                    <form action="RecursaReuniaoCoordenadaor" name="reuniaoForm">
                        ...
                        <div class="botão">
                            <input type="checkbox" onclick="AdicionarReivindicacao('DescricaoDaReprovacao','confirmar')" value="Reprovar" > Rejeitar Reunião
                    ...
                    <div class="botão">
                        ...
                        <button id="confirmar" onclick="location.href = 'ConfirmarReuniaoCoordenador?idReuniao=${reuniaoAguardandoConfirmacao.idReuniao}'" class="btn btn-success">Confirmar Reunião</button>
                    </div>
