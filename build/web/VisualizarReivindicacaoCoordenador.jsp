            ...
            <div class="panel panel-primary ocutarVisualizacao " id="visualizaReivindicacao">
                ...
                <div class="panel-body">
                    <form action="IncluirStatusReprovadaCoordenador" name="reuniaoForm">
                        ...
                        <div class="botão">
                            <input type="checkbox" onClick="ConfirmaReprovamento('DescricaoDaReprovacao','Confirmar')" value="Reprovar" > Rejeitar Reivindicação
                        ...
                        <div  id="DescricaoDaReprovacao" style="display: none;">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="botão">
                                    <input type="submit" class="btn btn-danger" value="Confirma Reprovação">
                                </div> 
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="botão">
                        ...
                        <button id="Confirmar" onclick="location.href = 'IncluirStatusConfirmada?idReivindicacao=${reivindicacao.idReivindicacao}'" class="btn btn-success">Confirmar Reivindicação</button>
                    </div>
