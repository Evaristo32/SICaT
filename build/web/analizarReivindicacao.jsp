                                            ...
                                            <c:forEach var="reivindicacoesConfirmada" items="${reivindicacoesConfirmada}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" onclick="location.href = 'DetalharReivindicacaoRepresentante?idReivindicacao=${reivindicacoesConfirmada.getIdReivindicacao()}'" class="btn-success">
                                                            Visualizar</button> 
                                                    </td>
                                                </tr> 
                                            </c:forEach>
